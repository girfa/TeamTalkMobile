...
public interface FileListener {
	void fileStart(FileInfo fileInfo, FileTransfer transfer);
	void fileProgress(FileInfo fileInfo, FileTransfer transfer);
	void fileFinish(FileInfo fileInfo, FileTransfer transfer);
}
